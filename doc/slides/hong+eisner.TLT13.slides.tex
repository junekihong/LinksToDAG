...
\begin{figure}
  \begin{dependency}
	\begin{deptext}
	  ...
	  - \& n-u \& v \& e \& e \& v \& v-d \& r \& n-u \& - \\
	\end{deptext}
	\deproot[edge above]{3}{\small ROOT}
	\depedge[edge below, edge style = {red, ultra thick}]{2}{3}{S}
	\depedge[edge above, edge style = {blue, ultra thick}]{3}{2}{\small SBJ}
	\depedge[edge above]{3}{4}{\small ADV}
	\depedge[edge above]{3}{5}{\small ADV}
	\depedge[edge below]{3}{6}{I}
	\depedge[edge above]{3}{6}{\small VC}
	\depedge[edge above, edge unit distance =1.5ex]{3}{10}{\small P}
	\depedge[edge below]{2}{1}{D}
	\depedge[edge above]{2}{1}{\small NMOD}
	\depedge[edge below]{7}{8}{MV}
    \depedge[edge above]{7}{8}{\small ADV}
	\depedge[edge below]{6}{7}{P}
	\depedge[edge above]{6}{7}{\small VC}
	\depedge[edge below]{8}{9}{J}
	\depedge[edge above]{8}{9}{\small PMOD}
	\deproot[edge below]{2}{W}
    \deproot[edge below]{7}{WV}
	\deproot[edge below]{10}{X}
	\depedge[edge below]{6}{4}{E}
	\depedge[edge below]{6}{5}{E}
  \end{dependency}
\end{figure}
