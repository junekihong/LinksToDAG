...
\begin{figure}
  \begin{dependency}
	\begin{deptext}
	  ...
	  - \& n-u \& v \& e \& e \& v \& v-d \& r \& n-u \& - \\
	\end{deptext}
	\deproot[edge above, edge style = {blue}]{3}{\small ROOT}
	\depedge[edge below, edge style = {red}]{2}{3}{S}
	\depedge[edge above, edge style = {blue}]{3}{2}{\small SBJ}
	\depedge[edge above, edge style = {blue}]{3}{4}{\small ADV}
	\depedge[edge above, edge style = {blue}]{3}{5}{\small ADV}
	\depedge[edge below, edge style = {red}]{3}{6}{I}
	\depedge[edge above, edge style = {blue}]{3}{6}{\small VC}
	\depedge[edge above, edge style = {blue}, edge unit distance =1.5ex]{3}{10}{\small P}
	\depedge[edge below, edge style = {red}]{2}{1}{D}
	\depedge[edge above, edge style = {blue}]{2}{1}{\small NMOD}
	\depedge[edge below, edge style = {red}]{7}{8}{MV}
	\depedge[edge above, edge style = {blue}]{7}{8}{\small ADV}
	\depedge[edge below, edge style = {red}]{6}{7}{P}
	\depedge[edge above, edge style = {blue}]{6}{7}{\small VC}
	\depedge[edge below, edge style = {red}]{8}{9}{J}
	\depedge[edge above, edge style = {blue}]{8}{9}{\small PMOD}
	\deproot[edge below, edge style = {red}]{2}{W}
	\deproot[edge below, edge style = {red}]{7}{WV}
	\deproot[edge below, edge style = {red}]{10}{X}
	\depedge[edge below, edge style = {red}]{6}{4}{E}
	\depedge[edge below, edge style = {red}]{6}{5}{E}
  \end{dependency}
