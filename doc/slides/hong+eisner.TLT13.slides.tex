...
\frame{\frametitle{Motivation}
  \begin{itemize}
    \item A multiheaded dependency corpus would be useful for building new parsers
  \end{itemize}
}
...
\frame{\frametitle{Relativization}
  \begin{figure}
    \begin{dependency}
      ...
      \end{deptext}
      \deproot[edge above, thick, hide label, edge unit distance = 1.5ex]{7}{}
      \depedge[edge above, thick, hide label]{2}{1}{}
      \depedge[edge above, thick, hide label]{2}{3}{}
...
\frame{\frametitle{Conjunction}
  \begin{figure}
    \begin{dependency}
      ...
      \end{deptext}
      \deproot[edge above, thick, hide label, edge unit distance = 1.5ex]{4}{}
      \depedge[edge above, thick, hide label]{2}{1}{}
      \depedge[edge above, thick, hide label]{2}{3}{}
...
\begin{figure}
  ...
  \caption*{Compare resulting dependency parse with CoNLL 2007 shared task}
\end{figure}
...
\section{ILP Model}
\frame{\frametitle{Integer Linear Programming Model: Variables}

For each sentence, for each edge $i,j$ where $i < j$, we introduce variables $x_{ij}$ and $x_{ji}$.

\NoteJH{TODO: Incomplete slide. Need to describe things like depth of the variable, label}
}


\frame{\frametitle{Integer Linear Programming Model: Encoded Constraints}
