...
\begin{figure}[t!]
  ...
  \caption{Rapid convergence to the direction mapping obtained on the largest dataset.  The direction mappings obtained on small datasets have high {\em precision} relative to the one obtained on the largest dataset.  {\em Recall} grows as more link types are seen and directionalized.}\label{fig:convergence}
  \vspace{-6pt}
\end{figure}
