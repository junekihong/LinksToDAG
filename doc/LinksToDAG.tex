...
The resulting English corpus uses an multi-headed annotation scheme that is somewhat different from the CoNLL annotations.  Differences are tabulated in Appendix~\ref{app:linktypes}, and the actual parses are contrasted in Figure~\ref{fig:parses} and Appendix~\ref{app:parses}.
...
\NoteJE{improve table formatting.  Numeric justification; longtable; remove most hlines.}
