...
def result_latex_corpus(original_sentence_count,
    ...
    result += "\t & Sentences \\\\ \n"
    result += "\t\t\\hline\n"
    result += "\t\tSentences used from the corpus & "+str(original_sentence_count)+"\\\\ \n"
    result += "\t\t\\hline\n"
    result += "\t\tAfter discarding disconnected parses & "+str(link_sentence_total)+"\\\\ \n"
    result += "\t\t\\hline\n"
    result += "\t\tComplete parses used for analysis & "+str(conll_analysis_sentence_count)+"\\\\ \n"
    result += "\t\t\\hline\n"
    result += "\t\\end{tabular}\n"
